...
if __name__ == "__main__":
    ...
    input_csv_path = os.path.join(os.path.dirname(__file__), '..', '..', 'Data', 'CSV-RAW-data', 'Java_test.csv')
    output_csv_path = os.path.join(os.path.dirname(__file__), '..', '..', 'Data', 'CSV-Labeled-data', 'labeled_java_test.csv')
